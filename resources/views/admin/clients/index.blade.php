                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            @if($client->logo)
                                            <div>
                                                <img src="{{ asset('storage/' . $client->logo) }}" class="avatar avatar-sm me-3" alt="logo" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;">
                                            </div>
                                            @endif
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ $client->city }} {{ $client->country ? ', ' . $client->country : '' }}</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ $client->industry }}</p>
                                    </td>
                                    <td class="align-middle">
                                        <a href="{{ route('clients.edit', $client->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                            Edit
                                        </a>
